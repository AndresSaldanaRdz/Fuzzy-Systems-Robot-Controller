...
#(Open turtlebot folder terminal) export TURcTLEBOT3_MODEL=burger -> ros2 launch turtlebot3_gazebo turtlebot3_world.launch.py
#(Open src terminal inside turtlebot) -> python3 fc_ref_sim.py
...
def movement():
    ...
    print("------------------------------")
    print("Distance front right: ", regions['fright'])
    print("Distance back right: ", regions['bright'])
    ...
    defuzzy = fuzzy_epoch(regions['fright'], regions['bright'], m1_p1=0.20, m1_p2=0.35, m2_p1=0.20, m2_p2=0.35, m2_p3=0.35, m2_p4=0.50, m3_p3=0.35, m3_p4=0.50)
